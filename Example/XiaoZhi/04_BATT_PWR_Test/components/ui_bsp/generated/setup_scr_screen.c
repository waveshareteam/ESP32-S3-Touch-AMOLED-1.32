...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_color(ui->screen_cont_1, lv_color_hex(0x020000), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_label_1, "Power ON");
    lv_label_set_long_mode(ui->screen_label_1, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_label_1, 75, 218);
    lv_obj_set_size(ui->screen_label_1, 310, 56);
    ...
    lv_obj_set_style_text_font(ui->screen_label_1, &lv_font_montserratMedium_33, LV_PART_MAIN|LV_STATE_DEFAULT);
